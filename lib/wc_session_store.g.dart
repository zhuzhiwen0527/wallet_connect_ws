...
WCSessionStore _$WCSessionStoreFromJson(Map<String, dynamic> json) {
  return WCSessionStore(
    ...
    remotePeerMeta: WCPeerMeta.fromJson(json['remotePeerMeta'] as Map<String, dynamic>),
...
Map<String, dynamic> _$WCSessionStoreToJson(WCSessionStore instance) => <String, dynamic>{
